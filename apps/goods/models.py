...
class GoodsCategory(models.Model):
    ...
    parent_category = models.ForeignKey('self',on_delete=models.CASCADE,null=True,blank=True,verbose_name="父级目类别",help_text="父目录",related_name="sub_cat")
...
class GoodsCategoryBrand(models.Model):
    """" 品牌名"""
    category = models.ForeignKey(GoodsCategory,on_delete=models.CASCADE,help_text="商品名称",blank=True,null=True,related_name="brands",verbose_name="商品名称")
    name = models.CharField(default="", max_length=30, verbose_name="类别名", help_text="类别名")
    desc = models.TextField(default="", verbose_name="类别描述", help_text="类别描述")
...
class Goods(models.Model):
    ...
    goods_sn = models.IntegerField(default=0,verbose_name="库存数")
    market_price = models.FloatField(default=0,verbose_name="市场价格")
    shop_price = models.FloatField(default=0,verbose_name="本店价格")
    goods_brief = models.TextField(max_length=500,verbose_name="商品剪短描述")
    goods_desc = UEditorField(verbose_name=u"内容", imagePath="goods/images/", width=1000, height=300,
                              filePath="goods/files/", default='')
    ship_free = models.BooleanField(default=True,verbose_name="是否承当运费")
